...
# Hierarchical cell: PmodCAN_0
proc create_hier_cell_PmodCAN_0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_PmodCAN_0() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_net -net ext_spi_clk_1_1 [get_bd_pins ext_spi_clk] [get_bd_pins axi_quad_spi_0/ext_spi_clk]
...
proc available_tcl_procs { } {
   ...
   puts "#"
   puts "#    create_hier_cell_PmodCAN_0 parentCell nameHier"
   puts "#"
   puts "##################################################################"
}
