...
---------------------------
* ext_spi_clk: When combined, the frequency ratio of the AXI Quad SPI IP core (default 16x1) and frequency of the ext_spi_clk must produce a SPI clock of less than 10 MHz.
The hierarchy was validated with an ext_spi_clk frequency of 50 MHz (50MHz / 16 = 3.125 MHz SPI clock frequency).
