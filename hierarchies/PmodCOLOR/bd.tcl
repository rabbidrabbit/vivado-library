...
# Hierarchical cell: PmodCOLOR_0
proc create_hier_cell_PmodCOLOR_0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_PmodCOLOR_0() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: PmodCOLOR_remap_0, and set properties
  set block_name PmodCOLOR_remap
  set block_cell_name PmodCOLOR_remap_0
  if { [catch {set PmodCOLOR_remap_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $PmodCOLOR_remap_0 eq "" } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.Use_Pullups_Top_Row {false} \
 ] $pmod_bridge_0
  ...
  connect_bd_intf_net -intf_net PmodCOLOR_remap_0_GPIO_OUT_TOP [get_bd_intf_pins PmodCOLOR_remap_0/GPIO_OUT_TOP] [get_bd_intf_pins pmod_bridge_0/GPIO_Top_Row]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_pins PmodCOLOR_remap_0/GPIO_IN] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_iic_0_IIC [get_bd_intf_pins PmodCOLOR_remap_0/IIC] [get_bd_intf_pins axi_iic_0/IIC]
  ...
  connect_bd_net -net s_axi_aclk_0_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn_0_1 [get_bd_pins s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn]
...
proc available_tcl_procs { } {
   ...
   puts "#"
   puts "#    create_hier_cell_PmodCOLOR_0 parentCell nameHier"
   puts "#"
   puts "##################################################################"
}
