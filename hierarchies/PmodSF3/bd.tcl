...
# Hierarchical cell: PmodSF3_0
proc create_hier_cell_PmodSF3_0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_PmodSF3_0() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir O -type intr qspi_interrupt
  ...
  connect_bd_net -net axi_quad_spi_0_ip2intc_irpt [get_bd_pins qspi_interrupt] [get_bd_pins axi_quad_spi_0/ip2intc_irpt]
  connect_bd_net -net ext_spi_clk_0_1 [get_bd_pins ext_spi_clk] [get_bd_pins axi_quad_spi_0/ext_spi_clk]
  connect_bd_net -net s_axi_aclk_0_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_quad_spi_0/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn_0_1 [get_bd_pins s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn]
...
proc available_tcl_procs { } {
   ...
   puts "#"
   puts "#    create_hier_cell_PmodSF3_0 parentCell nameHier"
   puts "#"
   puts "##################################################################"
}
