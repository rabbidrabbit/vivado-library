...
# Hierarchical cell: PmodCLS_0
proc create_hier_cell_PmodCLS_0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_PmodCLS_0() - Empty argument(s)!"}
     return
  }
...
proc available_tcl_procs { } {
   ...
   puts "#"
   puts "#    create_hier_cell_PmodCLS_0 parentCell nameHier"
   puts "#"
   puts "##################################################################"
}
