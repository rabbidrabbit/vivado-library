...
# Hierarchical cell: PmodACL2_0
proc create_hier_cell_PmodACL2_0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_PmodACL2_0() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins S_AXI_QSPI] [get_bd_intf_pins axi_quad_spi_0/AXI_LITE]
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins pmod_bridge_0/in_top_spi_ss_o]
  connect_bd_net -net axi_gpio_0_gpio2_io_t [get_bd_pins axi_gpio_0/gpio2_io_t] [get_bd_pins pmod_bridge_0/in_top_spi_ss_t]
  ...
  connect_bd_net -net pmod_bridge_0_in_top_spi_ss_i [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins pmod_bridge_0/in_top_spi_ss_i]
...
proc available_tcl_procs { } {
   ...
   puts "#"
   puts "#    create_hier_cell_PmodACL2_0 parentCell nameHier"
   puts "#"
   puts "##################################################################"
}
