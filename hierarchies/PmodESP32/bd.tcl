...
# Hierarchical cell: PmodESP32_0
proc create_hier_cell_PmodESP32_0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_PmodESP32_0() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir O -type intr uart_interrupt
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S_AXI_UART] [get_bd_intf_pins axi_uartlite_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_pins axi_gpio_0/GPIO2] [get_bd_intf_pins pmod_bridge_0/GPIO_Bottom_Row]
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_pins axi_uartlite_0/UART] [get_bd_intf_pins pmod_bridge_0/UART_Top_Row]
  ...
  connect_bd_net -net axi_uartlite_0_interrupt [get_bd_pins uart_interrupt] [get_bd_pins axi_uartlite_0/interrupt]
  connect_bd_net -net s_axi_aclk_0_1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk]
  connect_bd_net -net s_axi_aresetn_0_1 [get_bd_pins s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn]
...
proc available_tcl_procs { } {
   ...
   puts "#"
   puts "#    create_hier_cell_PmodESP32_0 parentCell nameHier"
   puts "#"
   puts "##################################################################"
}
